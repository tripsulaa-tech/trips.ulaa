    ...
    <Layout>
      ...
      */}
      ...
      <Modal
        isOpen={bookingOpen}
        onClose={async () => {
          // Closing (backdrop click, Escape, or the X button all funnel
          // through this same onClose) with unsaved details entered would
          // otherwise silently discard them with no warning — most often
          // an accidental backdrop click. Confirm first when there's
          // actually something to lose. The draft itself is kept either
          // way (see bookingDraft/onDraftChange below), so even a
          // deliberate close doesn't lose what was typed — reopening the
          // form brings it right back.
