...
import type { UpcomingTrip, TripHighlightCard, TripIncludedGroup, ItineraryDay, ButtonLabelsConfig } from '../types/types-index';
...
import {
  type AnyIcon, type RGB, type PdfListItem,
  rgbToHex, resolveIcon, getThingsToCarryFallbackIcon,
  BRAND, PAGE_W, PAGE_H, MARGIN, CONTENT_W, CONTENT_BOTTOM,
  COLORS, CONFIDENCE_PALETTE, money, heroMoneyRupee,
  sanitizeTrip, tierLabel, loadCoverCroppedImage,
