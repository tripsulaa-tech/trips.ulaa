        ...
        >
          ...
          >
            ...
            <div className="relative h-36 sm:h-44 w-full">
              ...
              <span className="absolute top-3 left-3 inline-flex items-center gap-1.5 bg-primary text-white text-2xs font-button font-bold uppercase tracking-wide px-3 py-1.5 rounded-md shadow-warm max-w-[calc(100%-3.5rem)]">
