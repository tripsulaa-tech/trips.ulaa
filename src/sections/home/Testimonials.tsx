...
export default function Testimonials() {
  ...
  // Elastic bumped up (and a velocity check added) to match the feel of
  // Lightbox.tsx's swipe — dragElastic 0.15 barely let the card move with
  // the finger before snapping only on release, which read as unresponsive.
