      ...
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="bg-white rounded-lg shadow-card p-4 sm:p-5 space-y-3">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <div className="flex flex-nowrap items-center justify-end gap-1.5 min-w-0 w-full sm:w-auto">
              {nma && (
                <Button variant="primary" size="sm" onClick={handleAdvance} disabled={busyAction} className="!px-3 !gap-1.5 text-xs whitespace-nowrap flex-1 sm:flex-none">
                  <nma.icon size={14} aria-hidden="true" /> {nma.label}
                </Button>
              )}
              {canMarkNotInterested(enquiry) && (
                <Button variant="outline" size="sm" onClick={handleMarkNotInterested} disabled={busyAction || busyStatus} className="!px-3 !gap-1.5 text-xs whitespace-nowrap flex-1 sm:flex-none">
        ...
        {!enquiry.booking_id && (
          <div className="bg-white rounded-lg shadow-card p-4 sm:p-5">
            ...
            <Button variant="primary" size="sm" onClick={openPayment} className="w-full sm:w-auto mt-4">
