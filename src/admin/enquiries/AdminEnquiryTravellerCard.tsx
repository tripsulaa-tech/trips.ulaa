              ...
              {editing ? (
                <>
                  ...
                  {!(editTouched.has('age') && editErrors.age) && editForm.trip_id && (
                    <p id="eq-detail-edit-age-hint" className="text-2xs text-dark-muted mt-1">Ages {effectiveMinAge}–{effectiveMaxAge}.</p>
                  )}
            ...
            <div className="min-w-0 flex-1">
              ...
              {editing && !enquiry.booking_id ? (
                ...
                <p className="text-dark text-sm font-semibold truncate">
                  ...
                  {editing && enquiry.booking_id && (
                    <span className="block text-2xs text-dark-muted font-normal">Change via Track Payment</span>
                  )}
                </p>
              )}
            </div>
