    ...
    <AdminLayout title="Upcoming Trips">
      ...
      >
        <div className="space-y-3">
          <CollapsibleSection title="Basic Info" description="Title, destination, dates" defaultOpen>
          ...
          <CollapsibleSection title="Pricing & Availability" description="Seats and price per person">
            <div>
          ...
          <CollapsibleSection title="Media" description="Cover image and photo gallery">
            <div className="md:col-span-2">
              <ImageUploadField
                label="Cover Image"
          ...
          <CollapsibleSection title="Overview & Itinerary" description="Highlights and the day-by-day plan">
            <div className="md:col-span-2">
              <TagListEditor
          ...
          <CollapsibleSection title="Inclusions & Prep" description="What's included, not included, and what to bring">
            <div>
              <TagListEditor
          ...
          <CollapsibleSection title="Meeting Point" description="Where travellers gather to start the trip">
            <div className="md:col-span-2">
          ...
          <CollapsibleSection title="Publish">
