    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] bg-dark/96 backdrop-blur-xl flex items-center justify-center p-3 sm:p-4"
          onClick={onClose}
        >
          {/* Close */}
          <button
